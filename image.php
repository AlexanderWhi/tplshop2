...
if ($stamp) {
    $znak = imagecreatefrompng("storage/stamp/stamp.png"); //177x22
    ...
    imagecopyresampled($dst_znak, $znak, 0, 0, 0, 0, $w, $h, imagesx($znak), imagesy($znak));

    imagecopy($dst_im, $dst_znak, (imagesx($dst_im) - imagesx($dst_znak)) / 2, (imagesy($dst_im) - imagesy($dst_znak)) / 2, 0, 0, imagesx($dst_znak), imagesy($dst_znak));
}
