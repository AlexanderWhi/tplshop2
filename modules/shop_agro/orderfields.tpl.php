...
<h2>Заказчик</h2>
		...
		<tr><th>Город</th><td><input name="city" value="<?=$city?>" class="input-text"></td></tr>
		
		<tr><th>Адрес</th><td><input name="address" value="<?=$address?>" class="input-text"></td></tr>
		
		<?}else{?>
		<tr><th>Адрес</th><td><?=$city?> <?=$address?></td></tr>
		<?}?>
