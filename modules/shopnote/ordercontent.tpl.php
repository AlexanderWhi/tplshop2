...
<td>
<a  title=" <?=htmlspecialchars($goods['description'])?>" class="title" href="http://<?=$_SERVER['HTTP_HOST']?>/catalog/goods/<?=$item['id']?>/"><?=$goods['name']?></a><div style="display:none"><?=$item['description']?></div>
</td>
</td>
