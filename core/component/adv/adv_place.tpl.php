	...
	<? while($rs->next()){?>
		<tr>
			<td style="width:200px">
				<img src="/img/pic/opnbr_16.gif" title="<?=htmlspecialchars($rs->get("description"));?>" alt="<?=htmlspecialchars($rs->get("description"));?>"/> 
				<a href="?act=plEdit&id=<?=$rs->get('id');?>"><strong>[<?=$rs->get("id");?>]</strong></a>
			</td>
			<td>
				<small>[<?=htmlspecialchars($rs->get("description"));?>]</small>
			</td>
